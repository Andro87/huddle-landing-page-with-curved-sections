        ...
        <div className={styles.wrap}>
            ...
            <header className={styles.header}>
                <div className={styles.navigation}>
                    ...
                    <Button type="rounded" color="white">
                        Try it
                    </Button>
                </div>
                ...
                <div className={styles.intro}>
                    ...
                    <Button type="rounded" color="pink">
                        ...
                        icon={
                            ...
                            >
                                ...
                                >
                                    ...
                                    <path d="M288.65 1656.86h-2.048a1.937 1.937 0 0 1-1.935-1.935v-9.357a3.997 3.997 0 0 1 2.745-3.801 16.956 16.956 0 0 1 10.621 0l-.367 1.108a15.783 15.783 0 0 0-9.887-.001 2.834 2.834 0 0 0-1.944 2.694l-.002 9.357c0 .424.345.768.77.768h2.047v1.167" />
                                </g>
                            </svg>
                        }
                        number="1.4k+"
            ...
            <Background
                background="first"
                intro="Grow Together"
                info="         Generate meaningful discussions with your audience
            ...
            <Background
                background="second"
                intro="Flowing Conversations"
                info="  You wouldn't paginate a conversation in real life,
            ...
            <Background
                background="third"
                intro=" Your Users"
                info=" It takes no time at all to integrate Huddle with your app's authentication solution. This means, 
            ...
            <section className={styles.ready}>
                <Header type="secondary">Ready To Build Your Community?</Header>
                <Button type="rounded" color="pink">
                    Get Started For Free
                </Button>
            </section>
            ...
            <footer className={styles.footer}>
                <div className={styles.footer_wrap}>
                    <div className={styles.interaction}>
                        ...
                        <p>
                            To recieve tips on how to grow your community, sign
                            up to our weekly newsletter. We’ll never send you
                    ...
                    <div className={styles.contact}>
                        ...
                        <p>
                            ...
                            elit. Mauris nulla quam, hendrerit lacinia
